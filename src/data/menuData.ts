...
export const defaultMenuItems: MenuItem[] = [
  // WAFFLES - Chocolate Blast @120
  { id: "w1", name: "Classic Chocolate", description: "Rich chocolate waffle with classic toppings", price: 120, category: "Waffles", isVeg: true },
  { id: "w2", name: "Milkyway", description: "Smooth milky chocolate waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w3", name: "Dark Temptation", description: "Intense dark chocolate waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w4", name: "Red Velvet", description: "Signature red velvet flavored waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w5", name: "Belgian Chocolate", description: "Premium Belgian chocolate drizzle", price: 120, category: "Waffles", isVeg: true },
  { id: "w6", name: "Eat Me Now", description: "Irresistible loaded chocolate waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w7", name: "Americano", description: "Coffee-infused chocolate waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w8", name: "Red Velvet Cream Cheese", description: "Red velvet with cream cheese topping", price: 120, category: "Waffles", isVeg: true },
  { id: "w9", name: "Butterscotch Crunch", description: "Crunchy butterscotch waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w10", name: "Maple Butter", description: "Classic maple butter glazed waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w11", name: "Bubblegum", description: "Fun bubblegum flavored waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w12", name: "Pulpy Orange", description: "Refreshing orange flavored waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w13", name: "Chocolate Almond", description: "Chocolate waffle with crunchy almonds", price: 120, category: "Waffles", isVeg: true },
  { id: "w14", name: "Caramel Kiss", description: "Sweet caramel drizzled waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w15", name: "Na Tere Na Mera", description: "A unique blend of flavors", price: 120, category: "Waffles", isVeg: true },
  { id: "w16", name: "Nutella", description: "Loaded with creamy Nutella", price: 120, category: "Waffles", isVeg: true },
  { id: "w17", name: "Oreo Cookie", description: "Crushed Oreo cookie waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w18", name: "Cocoa Mocha", description: "Coffee meets chocolate waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w19", name: "Melody", description: "Sweet melody of chocolate", price: 120, category: "Waffles", isVeg: true },
  { id: "w20", name: "Bourbon Whisky", description: "Bourbon biscuit flavored waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w21", name: "Kitty Katkat", description: "Crispy KitKat waffle delight", price: 120, category: "Waffles", isVeg: true },
  { id: "w22", name: "Gems Surprise", description: "Colorful gems topped waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w23", name: "Coffee Toffee", description: "Coffee and toffee fusion", price: 120, category: "Waffles", isVeg: true },
  { id: "w24", name: "Rock It Chocolate", description: "Intense rocky chocolate waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w25", name: "Munch Mania", description: "Crunchy munch bar waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w26", name: "Laila Majnu", description: "A pair of flavors in one", price: 120, category: "Waffles", isVeg: true },
  { id: "w27", name: "Dark Bourbon", description: "Dark/White/Milk chocolate bourbon", price: 120, category: "Waffles", isVeg: true },
  { id: "w28", name: "Pati Patni Aur Woh", description: "Triple flavor surprise waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w29", name: "Eclairs", description: "Eclairs chocolate waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w30", name: "Jimmy Jimmy", description: "Sprinkled jimmies waffle", price: 120, category: "Waffles", isVeg: true },
  // Cream Crush Waffles
  { id: "w31", name: "Blueberry Cream Crush", description: "Fresh blueberry cream waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w32", name: "Strawberry Cream Crush", description: "Strawberry cream topped waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w33", name: "Mango Cream Crush", description: "Tropical mango cream waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w34", name: "Halwai Se", description: "Indian sweet inspired waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w35", name: "Rasmalai Pistachio", description: "Rasmalai with pistachio crush", price: 120, category: "Waffles", isVeg: true },
  { id: "w36", name: "Banarsi Paan", description: "Paan flavored waffle", price: 120, category: "Waffles", isVeg: true },
  { id: "w37", name: "Mathura Peda", description: "Classic peda inspired waffle", price: 120, category: "Waffles", isVeg: true },

...
const TrackOrderPage = () => {
  ...
  // Support direct link with order id (from checkout redirect)
  useEffect(() => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (!trimmed) return;
    const results = getOrdersByPhone(trimmed);
  ...
  return (
    <div className="min-h-screen max-w-2xl mx-auto px-4 py-6">
      ...
      <p className="text-muted-foreground mb-8">Enter your phone number to see your orders</p>
      ...
      <form onSubmit={handleSearch} className="flex gap-3 mb-8">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-2xl bg-card border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30"
                          ...
                          <div className="flex flex-col items-center">
                            <div
                              className={`w-10 h-10 rounded-full flex items-center justify-center ${
                                isCompleted ? "waffle-gradient" : "bg-secondary"
                              }`}
                            >
